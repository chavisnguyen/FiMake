...
features:
  - icon: "🎨"
    ...
    details: 29 tools — create frames, rectangles, text, components, instances, prototype links, colors, layout, and more. The official MCP server can't change anything; Fimake can.
  - icon: "🔌"
  ...
  - icon: "🛡️"
    ...
    details: 23 tools forward directly to the plugin, 6 have Node-side logic. Parity is enforced by mcp/tests/contract/mcp-tools.test.ts so agents never hit a ghost tool.
---
