...
2. **Keep the plugin window open.** It flips to **Connected** once the MCP server (step 2) is running.
...
>
> Not on macOS, or `install-plugin` doesn't work for you? See [manual sideload](docs/troubleshooting.md#install-the-plugin-manually).
